function newmap = alternative_map(cmin_input,cmax_input,rgbmin,rgb0,rgbmax)
...
if nargin ~= 5 ;
   disp('input error');
   disp('input 1)&2) the range of caxis, 3) color for min, 4) color for 0, 5) color for max')
end
